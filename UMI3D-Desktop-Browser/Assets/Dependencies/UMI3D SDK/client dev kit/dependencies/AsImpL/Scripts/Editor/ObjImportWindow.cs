...
namespace AsImpL
{
    ...
    public class ObjImportWindow : EditorWindow
    {
        ...
        [UnityEditor.MenuItem("Assets/Import OBJ model... [AsImpL]", false, 20)]
        private static void ShowWindow()
        {
            GetWindow<ObjImportWindow>(false, "OBJ import", true);
        }

        [UnityEditor.MenuItem("Window/Capture screenshot [AsImpL]", false)]
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Import", GUILayout.Width(80), GUILayout.Height(24)))
            {
                ...
                if (!string.IsNullOrEmpty(absolute_path))
                {
                    ...
                    // NEED TO TAKE RESOURCE AND NOT ABSOLUTE_PATH
