...
namespace AsImpL
{
    ...
    public abstract class Loader : MonoBehaviour
    {
        ...
        public IEnumerator Load(string objName, Resource resource, Transform parentObj)
        {
            var absolutePath = resource.Url.Replace('\\', '/');
            ...
            if (buildOptions != null && buildOptions.reuseLoaded && loadedModels.ContainsKey(absolutePath) && loadedModels[absolutePath] != null)
            {
                ...
                if (parentObj != null) newObj.transform.SetParent(parentObj.transform, false);
            ...
            yield return LoadModelFile(resource);
            ...
            {
                yield return LoadMaterialLibrary(resource);
            }
        ...
        protected abstract IEnumerator LoadModelFile(Resource resource);
        ...
        /// <param name="absolutePath">absolute file path</param>
        /// <remarks>This is called by Load() method</remarks>
        protected abstract IEnumerator LoadMaterialLibrary(Resource resource);
                ...
                foreach (MaterialData mtl in materialData)
                {
                    ...
                    if (mtl.diffuseTexPath != null)
                    {
...
#endif
                        {
                            ...
                            {
                                Debug.Log(loader.error + " : " + texPath);
                            }
                            else
                            {
        ...
        /// <summary>
        /// Load a texture from a URL using a UnityWebRequest
        /// </summary>
        /// <param name="loader">UnityWebRequest object (already loaded)</param>
