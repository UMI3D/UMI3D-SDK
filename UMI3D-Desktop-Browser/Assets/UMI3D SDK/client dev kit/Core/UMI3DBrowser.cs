...
namespace umi3d.cdk
{
    ...
    public class UMI3DBrowser : Singleton<UMI3DBrowser>
    {
        ...
        public static AbstractPlayer Player
        {
            get
            {
                return Exist ? Instance.player : null ;
            }
        }
        ...
        /// <summary>
        /// Local scene displayed on connection to media environments.
        /// </summary>
        public GameObject MediaEnvironment;
        ...
        /// </summary>
        /// <param name="callback">Callback to subscribe (the argument is the environment's name)</param>
        ...
        public static void OpenEnvironment(EnterDto data)
        {
           ...
           // instance.EnterTeleportationAfterSetup(data.UserPosition);
        ...
        {
            Debug.LogWarning("tp pos" + positionToTeleport);
        ...
        public static void ChangeEnvironment(MediaDto dto)
        {
            ...
            Instance.onConnectionToEnvironment.Invoke(dto.Name);

            Instance.MediaEnvironment.SetActive(dto.EnvironmentType == EnvironmentType.Media);
            Scene.transform.SetParent(dto.EnvironmentType == EnvironmentType.Media ? Instance.MediaAnchor : Instance.WorldAnchor, false);

            /*
            if (dto.Skybox != null)
            {
                RenderSettings.ambientMode = AmbientMode.Skybox;
                Scene.SetSkybox(dto.Skybox);
            } else
            {
                RenderSettings.ambientMode = AmbientMode.Flat;
                RenderSettings.ambientLight = Color.white;
        ...
        {
            if (Media != null)
                Instance.onDisconnectionFromEnvironment.Invoke(Media.Name);
            ...
            ResetModules();
            Instance.MediaEnvironment.SetActive(true);
        }
    }
}