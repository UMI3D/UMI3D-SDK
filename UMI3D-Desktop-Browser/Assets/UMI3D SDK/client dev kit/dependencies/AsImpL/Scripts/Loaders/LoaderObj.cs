...
namespace AsImpL
{
    ...
    public class LoaderObj : Loader
    {
        ...
        protected override IEnumerator LoadModelFile(Resource resource)
        {
        ...
        protected override IEnumerator LoadMaterialLibrary(Resource resource)
        {
            string mtlPath;
            ...
            if (absolutePath.StartsWith("http:/") && !absolutePath.StartsWith("http://"))
            {
                absolutePath = absolutePath.Insert(6, "/");
            }
            else if (absolutePath.StartsWith("https:/") && !absolutePath.StartsWith("https://"))
            {
                absolutePath = absolutePath.Insert(7, "/");
            }
            ...
            Debug.Log(resource.Url + " To" + mtlPath);
