...
namespace umi3d.example
{
    public class TranslationExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            defaultPosA = A.transform.localPosition;
            defaultScaB = B.transform.localScale;

        }
        Vector3 defaultPosA, defaultScaB;
        ...
        {
            //directly set the deltaXYZ to the localPosition
            A.transform.localPosition += deltaXYZ;
            //directly set the deltaXYZ to the Scale
            B.transform.localScale += deltaXYZ;
            // calculating a color based on the deltaXYZ
            colorTmp += deltaXYZ*Time.deltaTime*10;
        ...
        private void Update()
        {
            ...
            if (allOut && !wasAllOut)
            {
                A.transform.localPosition = defaultPosA;
                B.transform.localScale = defaultScaB;
