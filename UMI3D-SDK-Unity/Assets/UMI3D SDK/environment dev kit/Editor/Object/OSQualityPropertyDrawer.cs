...
{
    [CustomPropertyDrawer(typeof(OSQualitycollection.OsQuality))]
    [CanEditMultipleObjects]
    public class OSQualityPropertyDrawer : PropertyDrawer
    {
        SerializedProperty DefaultQuality;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            DefaultQuality = property.FindPropertyRelative("path");
            ...
            Rpath.width = RLine.width - RLabel.width - Rbrowse.width /*+ 3 * offset*/;

            Rpath.x = RLabel.width + offset;
            ...
            EditorGUI.PropertyField(Rpath, DefaultQuality, GUIContent.none);
            ...
            if (GUI.Button(Rbrowse, GBut))
            {
                ...
                if (FolderPath != null && FolderPath != "")
                {
                    ...
                    else DefaultQuality.stringValue = FolderPath.Split(new string[] { path }, StringSplitOptions.None)[1];
                }
            }
