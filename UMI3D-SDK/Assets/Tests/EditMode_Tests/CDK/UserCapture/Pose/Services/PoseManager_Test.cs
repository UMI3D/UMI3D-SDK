...
namespace EditMode_Tests.UserCapture.Pose.CDK
{
    ...
    public class PoseManager_Test
    {
        ...
        //{
        //    // GIVEN
        //    var poseDataMock = new Mock<IUMI3DPoseClipData>();
        //    poseDataMock.Setup(x => x.ToPoseDto()).Returns(new PoseDto());
        //    userCaptureLoadingParametersMock.Setup(x => x.ClientPoses).Returns(new List<IUMI3DPoseClipData>()
        //    {
        //        poseDataMock.Object,
        //        poseDataMock.Object,
        //        poseDataMock.Object,
        ...
        //    PoseOverridersContainer overrider = new(dto, new PoseAnimator[0]);
        ...
        //    // When
        //    TestDelegate action = () => poseManager.RemovePoseOverrider(overrider);
        ...
        //    {
        //        id = 1005uL,
        //        poseOverriderDtos = new PoseAnimatorDto[]
        //        {
        //            new()
        //            {
                      
        //                poseIndexInPoseManager = 1,
        //                activationMode = (ushort)PoseAnimatorActivationMode.AUTO
        //            },
        //        },
        ...
        //    poseManager.Poses.Add(dto.relatedNodeId, new List<PoseClip>() { new PoseClip(new PoseDto() { index = 1 }) });
        ...
        //{
        //    // Given
        //    PoseAnimator overrider = null;

        //    // When
        //    TestDelegate action = () => poseManager.PlayPoseClip(overrider);
        ...
        //{
        //    // Given
        //    var dto = new PoseAnimatorDto()
        //    {
        //        poseIndexInPoseManager = 1,
        //        activationMode = (ushort)PoseAnimatorActivationMode.AUTO
        //    };
        //    PoseAnimator overrider = new PoseAnimator(dto, new IPoseCondition[0]);

        //    poseManager.Poses[UMI3DGlobalID.EnvironementId].Add(new PoseClip(new PoseDto() { index = 1 }));
        ...
        //    // When
        //    poseManager.PlayPoseClip(overrider);
        ...
        //    // When
        //    TestDelegate action = () => poseManager.StopPoseClip(overrider);
        ...
        //    // When
        //    poseManager.StopPoseClip(overrider);
        ...
        //private Dictionary<ulong, IList<PoseClip>> GeneratePoseDictionary()
        //{
        //    Dictionary<ulong, IList<PoseClip>> allPoses = new Dictionary<ulong, IList<PoseClip>>()
        //    {
        //        {0,
        //            new List<PoseClip>()
        //            {
