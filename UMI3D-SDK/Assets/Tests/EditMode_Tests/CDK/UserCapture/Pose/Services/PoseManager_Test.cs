...
namespace EditMode_Tests.UserCapture.Pose.CDK
{
    ...
    public class PoseManager_Test
    {
        ...
        public void TryActivatePoseAnimator()
        {
            ...
            poseSubskeletonMock.Setup(x => x.StartPose(It.IsAny<PoseClip>(), false, It.IsAny<IPosePlayer.PosePlayingParameters>()));
            // When
            bool result = false;
        ...
        public void PlayPoseClip()
        {
            ...
            // Then
            poseSubskeletonMock.Verify(x => x.StartPose(It.IsAny<PoseClip>(), false, It.IsAny<IPosePlayer.PosePlayingParameters>()), Times.Once());
        ...
        public void PlayPoseClip_WithAnchoring_Specified()
        {
            ...
            // When
            poseManager.PlayPoseClip(poseClip, new IPosePlayer.PosePlayingParameters() { isAnchored = true, anchor = anchorDto });
        ...
        public void PlayPoseClip_AlreadyPlayed()
        {
            ...
            // Then
            poseSubskeletonMock.Verify(x => x.StartPose(It.IsAny<PoseClip>(), false, It.IsAny<IPosePlayer.PosePlayingParameters>()), Times.Never());
        }
