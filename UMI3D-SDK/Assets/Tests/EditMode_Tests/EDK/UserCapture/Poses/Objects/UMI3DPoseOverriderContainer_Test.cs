...
{
    [TestFixture, TestOf(nameof(UMI3DPoseOverriderContainer))]
    public class UMI3DPoseOverriderContainer_Test
    {
        #region Init
        ...
        {
            // GIVEN
            UMI3DPoseOverriderContainer container = new(0, new List<IUMI3DPoseOverriderData>());
        ...
        public void ToEntityDto()
        {
            ...
            // WHEN
            var dto = (UMI3DPoseOverridersContainerDto)container.ToEntityDto();
