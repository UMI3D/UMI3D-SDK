...
namespace Mumble
{
    public class MumbleTcpConnection
    {
        ...
        {
#if UNITY_EDITOR
            ///Revert this change du to unity editor crash
            ...
            _tcpClient = new TcpClient(host.AddressFamily);
        ...
        internal void SendMessage<T>(MessageType mt, T message)
        {
            lock (_ssl)
            {
                ...
                else
                {
                    ...
                    _model.Serialize(messageStream, message);
        ...
        private T DeserializeWithLengthPrefix<T>(Stream source, PrefixStyle prefixStyle)
        {
            return (T)_model.DeserializeWithLengthPrefix(source, null, typeof(T), prefixStyle, 4);
        }
                ...
                try
                {
                    ...
                    switch (messageType)
                    {
                        ...
                        case MessageType.SuggestConfig:
                            ...
                            /*Serializer.*/
                            DeserializeWithLengthPrefix<SuggestConfig>(_ssl,
                 PrefixStyle.Fixed32BigEndian);
                            break;
