...
namespace umi3d.cdk
{
    public static partial class UMI3DClient
    {
        ...
        static class SceneManager
        {
            ...
            static UMI3DClientLogger logger = new UMI3DClientLogger(mainTag: $"{nameof(SceneManager)}");
        ...
        {
            return SceneManager.LoadSceneAsync(sceneToLoad, shouldStopLoading, loadingProgress, loadingSucced, loadingFail, loadMode, report);
        }
        ...
        {
            return SceneManager.UnloadSceneAsync(sceneToUnload, unloadingProgress, unloadingSucced, unloadMode, report);
        }
    }
}
