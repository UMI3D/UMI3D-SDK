...
namespace umi3d.cdk.interaction
{
    ...
    public class GlobalToolMenuManager : inetum.unityUtils.SingleBehaviour<GlobalToolMenuManager>
    {
        ...
        [Obsolete("This class or method will be removed when the new label feature will be activated.")]
        /// <summary>
        /// Retrieve the adequate <see cref="AbstractMenuItem"/> for a given interaction that belongs to a tool.
        /// </summary>
        ...
        [Obsolete("This class or method will be removed when the new label feature will be activated.")]
        public static AbstractMenuItem _GetInteractionItem(AbstractInteractionDto dto)
        {
        ...
        [Obsolete("This class or method will be removed when the new label feature will be activated.")]
        public static (AbstractMenuItem, ParameterSettingRequestDto) GetInteractionItem(AbstractInteractionDto dto)
        {
            AbstractMenuItem result = null;
            ParameterSettingRequestDto requestDto = null;
            switch (dto)
