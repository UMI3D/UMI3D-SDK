...
{
    public class ToggleControlEntity : AbstractControlEntity, IUIControlEntity
    {
        public UIInputType input = new();

        public ToggleControlEntity()
        {
        ...
        {
            if (value is not bool _value)
            {
                throw new Exception($"[UMI3D] Control: ui input value is not bool");
            }
