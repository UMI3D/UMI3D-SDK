...
namespace umi3d.cdk.menu
{
    ...
    public class ColorInputMenuItem : AbstractInputMenuItem<Color>
    {
        ...
        /// </summary>
        private readonly List<Action<Color>> subscribers = new List<Action<Color>>();
        ...
        public override void NotifyValueChange(Color newValue)
        {
            value = newValue;
            foreach (Action<Color> sub in subscribers)
            {
                sub.Invoke(newValue);
            }
        }
        ...
        public override bool Subscribe(Action<Color> callback)
        {
