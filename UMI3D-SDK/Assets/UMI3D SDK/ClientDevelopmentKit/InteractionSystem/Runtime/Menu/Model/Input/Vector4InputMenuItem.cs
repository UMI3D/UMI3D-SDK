...
namespace umi3d.cdk.menu
{
    ...
    /// </summary>
    public class Vector4InputMenuItem : AbstractInputMenuItem<Vector4>
    {
        /// <summary>
        /// Input value.
        /// </summary>
        ...
        /// </summary>
        private readonly List<Action<Vector4>> subscribers = new List<Action<Vector4>>();
        ...
        public override void NotifyValueChange(Vector4 newValue)
        {
            value = newValue;
            foreach (Action<Vector4> sub in subscribers)
            {
                sub.Invoke(newValue);
            }
        }
        ...
        public override bool Subscribe(Action<Vector4> callback)
        {
        ...
        public override bool UnSubscribe(Action<Vector4> callback)
        {
