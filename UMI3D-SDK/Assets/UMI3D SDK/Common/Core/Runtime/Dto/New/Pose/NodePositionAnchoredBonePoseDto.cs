...
namespace umi3d.common.userCapture
{
    ...
    public class NodePositionAnchoredBonePoseDto : BonePoseDto
    {
        ...
        public NodePositionAnchoredBonePoseDto(uint node, uint bone, SerializableVector3 position, SerializableVector4 rotation) 
            : base(bone, position, rotation)
        {
            this.node = node;
        }

        public NodePositionAnchoredBonePoseDto(uint node, BonePoseDto bonePoseDto) 
