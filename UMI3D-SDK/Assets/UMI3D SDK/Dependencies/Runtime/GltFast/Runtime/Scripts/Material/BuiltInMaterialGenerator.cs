...
namespace GLTFast.Materials {
    ...
    public class BuiltInMaterialGenerator : MaterialGenerator {
        ...
        protected const string KW_ALPHABLEND_ON = "_ALPHABLEND_ON";
        protected const string KW_ALPHAPREMULTIPLY_ON = "_ALPHAPREMULTIPLY_ON";
        protected const string KW_EMISSION = "_EMISSION";
        protected const string KW_METALLIC_ROUGNESS_MAP = "_METALLICGLOSSMAP";
        protected const string KW_OCCLUSION = "_OCCLUSION";
        protected const string KW_SPEC_GLOSS_MAP = "_SPECGLOSSMAP";

        protected static readonly int glossinessPropId = Shader.PropertyToID("_Glossiness");
        protected static readonly int metallicGlossMapPropId = Shader.PropertyToID("_MetallicGlossMap");
        protected static readonly int metallicRoughnessMapScaleTransformPropId = Shader.PropertyToID("_MetallicGlossMap_ST");
        protected static readonly int metallicRoughnessMapRotationPropId = Shader.PropertyToID("_MetallicGlossMapRotation");
        protected static readonly int metallicRoughnessMapUVChannelPropId = Shader.PropertyToID("_MetallicGlossMapUVChannel");
        protected static readonly int modePropId = Shader.PropertyToID("_Mode");
        protected static readonly int roughnessPropId = Shader.PropertyToID("_Roughness");

/*#if UNITY_EDITOR
        protected const string SHADER_PATH_PREFIX = "Assets/UMI3D SDK/Dependencies/Runtime/GltFast/Runtime/Shader/Built-In/";// "Packages/com.atteneder.gltfast/Runtime/Shader/Built-In/";
        protected const string SHADER_PATH_PBR_METALLIC_ROUGHNESS = "glTFPbrMetallicRoughness.shader";
        protected const string SHADER_PATH_PBR_SPECULAR_GLOSSINESS = "glTFPbrSpecularGlossiness.shader";
        protected const string SHADER_PATH_UNLIT = "glTFUnlit.shader";
#else*/
...
//#endif
        ...
        protected virtual Material GetPbrMetallicRoughnessMaterial(bool doubleSided=false) {
        ...
        protected Material GetPbrSpecularGlossinessMaterial(bool doubleSided=false) {
        ...
        protected Material GetUnlitMaterial(bool doubleSided=false) {
            if(unlitShader==null) {
