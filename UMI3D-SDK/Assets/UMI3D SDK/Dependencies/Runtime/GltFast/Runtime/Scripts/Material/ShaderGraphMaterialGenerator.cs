...
namespace GLTFast.Materials {
    ...
    public class ShaderGraphMaterialGenerator : MaterialGenerator {
        ...
        public override Material GenerateMaterial(Schema.Material gltfMaterial, IGltfReadable gltf, string url, int id) {
        ...
        protected Material GetUnlitMaterial(Schema.Material gltfMaterial)
        {
        ...
        protected Material GetSpecularMaterial(SpecularShaderFeatures features) {
