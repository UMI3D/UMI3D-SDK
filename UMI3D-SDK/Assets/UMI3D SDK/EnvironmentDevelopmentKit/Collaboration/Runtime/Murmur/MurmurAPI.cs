...
namespace umi3d.edk.collaboration.murmur
{
    ...
    //public class __MurmurAPI : MonoBehaviour
    //{

    //    string ip = "20.199.41.101";
    //    MurmurAPI m;
    ...
    //    async void Debug()
    //    {
    //        //var info = await m.GetServers();
    //        //var datas = Convert<_MurmurAPI.ServerDataShort[]>(info);
    //        //UnityEngine.Debug.Log(info);

    //        //info = await m.GetServerInfo(1);
    //        //var data = Convert<_MurmurAPI.ServerData>(info);
    //        //UnityEngine.Debug.Log(info);


    //        //for (int i = 1; i < 8; i++)
    //        //{
    //        //    info = await m.CreateChannel(1, $"room{i}", 0);
    //        //    var ch = Convert<_MurmurAPI.ChannelData>(info);
    //        //    UnityEngine.Debug.Log(info);
    //        //}

    //        //for (int i = 1; i < 8; i++)
    //        //    UnityEngine.Debug.Log(await m.DeleteChannel(1, i));

    //        //info = await m.GetServerInfo(1);
    //        //data = Convert<_MurmurAPI.ServerData>(info);
    //        //UnityEngine.Debug.Log(info);

    //        var serv = await MurmurAPI.Server.Create(m, 1);

    //        var id = new List<int>();
    //        for (int i = 0; i < 8; i++)
    //            id.Add(i);
    //        await Task.WhenAll(id.Select(async i =>
    //        {
    //            await serv.CreateChannel($"room{i}");
    //        }));

    //        await Task.WhenAll(serv.Channels.Select(async c =>
    //        {
    //            await c.DeleteChannel();
    //        }));
