...
namespace umi3d.cdk.collaboration
{
    ...
    public class HttpClient1
    {
        ...
        private readonly UMI3DEnvironmentClient1 environmentClient;

        /// <summary>
        /// Init HttpClient.
        /// </summary>
        /// <param name="UMI3DClientServer"></param>
        public HttpClient1(UMI3DEnvironmentClient1 environmentClient)
        {
        ...
        private static bool DefaultShouldTryAgain(RequestFailedArgument1 argument)
        {
        ...
        public static async Task<UMI3DDto> Connect(ConnectionDto connectionDto, string MasterUrl, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        public async Task<UserConnectionDto> SendGetIdentity(Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<PendingTransactionDto> SendPostUpdateIdentity(UserConnectionAnswerDto answer, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
            PendingTransactionDto result = null;
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async void SendPostUpdateStatusAsync(StatusType status, bool throwError = false, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
            try
            {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task SendPostUpdateStatus(StatusType status, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task SendPostLogout(Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<MediaDto> SendGetMedia(Func<RequestFailedArgument1, bool> shouldTryAgain)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public static async Task<MediaDto> SendGetMedia(string url, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<LibrariesDto> SendGetLibraries(Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        public async Task<LoadEntityDto> SendPostEntity(EntityRequestDto id, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<byte[]> SendGetPublic(string url, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        public async Task<byte[]> SendGetPrivate(string url, bool useParameterInsteadOfHeader, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<GlTFEnvironmentDto> SendGetEnvironment(Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<EnterDto> SendPostJoin(JoinDto join, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task SendPostSceneRequest(Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        public async Task SendPostLocalInfo(string key, byte[] bytes, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="callback">Action to be call when the request succeed.</param>
        /// <param name="onError">Action to be call when the request fail.</param>
        public async Task<byte[]> SendGetLocalInfo(string key, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="shouldTryAgain"></param>
        public async Task SendPostFile(string token, string fileName, byte[] bytes, Func<RequestFailedArgument1, bool> shouldTryAgain = null)
        {
        ...
        /// <param name="onError">Action to be call when the request fail.</param>
        /// <returns></returns>
        private static async Task<UnityWebRequest> _GetRequest(string HeaderToken, string url, Func<RequestFailedArgument1, bool> ShouldTryAgain, bool UseCredential = false, List<(string, string)> headers = null, int tryCount = 0)
        {
...
#endif
            {
                ...
                //if (UMI3DClientServer.Exists && await UMI3DClientServer.Instance.TryAgainOnHttpFail(new RequestFailedArgument1(www, tryCount, date, ShouldTryAgain)))
        ...
        /// <param name="onError">Action to be call when the request fail.</param>
        /// <returns></returns>
        private static async Task<UnityWebRequest> _PostRequest(string HeaderToken, string url, string contentType, byte[] bytes, Func<RequestFailedArgument1, bool> ShouldTryAgain, bool UseCredential = false, List<(string, string)> headers = null, int tryCount = 0)
        {
