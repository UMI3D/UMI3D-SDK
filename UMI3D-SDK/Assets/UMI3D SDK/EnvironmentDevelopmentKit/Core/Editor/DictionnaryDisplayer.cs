        ...
        public void Display(ref bool showDict, SerializedProperty KeyList, SerializedProperty ValueList, Dictionary<T, L> Dictionnary)
        {
            ...
            if (showDict)
            {
                ...
                if (GUILayout.Button("Add"))
                {
                    ...
                    {
                        KeyValuePair<T, L> k = NewValue(null, null);
                        Dictionnary.Add(k.Key, k.Value);
                    }
                    else
                    {
                        KeyValuePair<T, L> k = NewValue(KeyList.GetArrayElementAtIndex(KeyList.arraySize - 1), ValueList.GetArrayElementAtIndex(ValueList.arraySize - 1));
                        Dictionnary.Add(k.Key, k.Value);
                    }
                }
                ...
                for (int i = 0; i < KeyList.arraySize; i++)
                {
                    ...
                    {
                        SerializedProperty elementProperty = KeyList.GetArrayElementAtIndex(i);
                        ...
                        SerializedProperty elementProperty1 = ValueList.GetArrayElementAtIndex(i);
