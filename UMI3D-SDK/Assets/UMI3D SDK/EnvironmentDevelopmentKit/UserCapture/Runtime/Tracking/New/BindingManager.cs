...
namespace umi3d.edk.userCapture
{
    public class BindingManager : Singleton<BindingManager>
    {
        ...
        /// <param name="newparent">a transform intended to be the new parent. If keepWorldPosition is true, newparent must be specified.</param>
        /// <returns>The list of associated SetEntityProperty</returns>
        public List<SetEntityProperty> RemoveBinding(UMI3DTrackedUser obj, int index, bool keepWorldPosition = false, UMI3DAbstractNode newparent = null)
        {
            var operations = new List<SetEntityProperty>();
        ...
        /// <param name="newparent">a transform intended to be the new parent. If keepWorldPosition is true, newparent must be specified.</param>
        /// <returns>The list of associated SetEntityProperty</returns>
        public List<SetEntityProperty> RemoveBinding(UMI3DUser user, UMI3DTrackedUser obj, int index, bool keepWorldPosition = false, UMI3DAbstractNode newparent = null)
        {
            var operations = new List<SetEntityProperty>();
