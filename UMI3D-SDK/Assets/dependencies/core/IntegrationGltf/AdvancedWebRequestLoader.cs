...
{
    public class AdvancedWebRequestLoader : IDataLoader
    {
        private readonly HttpClient httpClient = new HttpClient(new HttpClientHandler(){ AutomaticDecompression = DecompressionMethods.GZip | DecompressionMethods.Deflate });
        private readonly Uri baseAddress;
        public string query;

        public AdvancedWebRequestLoader(string rootUri)
        {
#if !WINDOWS_UWP
